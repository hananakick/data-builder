 ...
 * 스키마 빌더 & 타입 레지스트리
 */
import { Schema, PrimitiveSchema, ArraySchema, ObjectSchema, CustomSchema, TypeDefinition } from './types';
/**
 ...
 */
export declare const SchemaBuilder: {
    /**
     ...
     * ```
     */
    custom(typeName: string, options?: {
        validator?: (value: any) => boolean | Promise<boolean>;
        innerSchema?: Schema;
    }): CustomSchema;
};
export declare const STRING_TYPE: TypeDefinition<'string'>;
export declare const NUMBER_TYPE: TypeDefinition<'number'>;
export declare const BOOLEAN_TYPE: TypeDefinition<'boolean'>;
/**
 ...
 * ```
 */
export declare function defineType<T extends string>(name: T, schema: Schema, description?: string): TypeDefinition<T>;
